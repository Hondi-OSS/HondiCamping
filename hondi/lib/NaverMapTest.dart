...
class _BaseMapPageState extends State<BaseMapPage> {
  ...
  _addMarker() {
    ...
    //var len = data.length;
    //for(var i = 0; i < len; i++) {
      //print(data[i]["mapX"].runtimeType);
      //print(data[i]["mapX"]);
      //print('latitude: ${data[i]["mapX"]}');
      //print('latitude: ${data[i]["mapY"]}');
      //print(data[i]["mapX"].runtimeType);
      //var x = data[i]["mapX"];// ?? 126.3542079;
      //var y = data[i]["mapY"];// ?? 33.4716860;
      //print('x'.runtimeType);
      _markers.add(Marker(
        markerId: 'id',
        //captionText: data[i]["facltNm"] ?? 'default value',
        position: LatLng(126.3542079, 33.4716860),
